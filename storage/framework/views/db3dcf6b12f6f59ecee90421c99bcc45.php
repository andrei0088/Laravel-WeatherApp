...
<section class="weather-wrapper grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 p-6" aria-label="Weather">
    <?php $__currentLoopData = $meteos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city => $meteo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('./layouts/app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\work\Laravel\weatherapp\resources\views/home.blade.php ENDPATH**/ ?>