...
<head>
  ...
  <link rel="icon" type="image/png" sizes="32x32" href="<?php echo e(asset('pub/logo.png')); ?>">
    ...
    <div class="container mx-auto flex justify-between items-center px-4 py-3">
      ...
      <div class="hidden md:flex items-center gap-6">
        <ul class="flex gap-6 text-lg font-medium text-gray-700">
          ...
          <li><a href=<?php echo e(route('about')); ?> class="hover:text-blue-600 transition">About</a></li>
          <li><a href=<?php echo e(route('contact')); ?> class="hover:text-blue-600 transition">Contact</a></li>
        </ul>
        <form action=<?php echo e(route('search')); ?> class="flex items-center bg-gray-100 rounded-lg overflow-hidden shadow-sm ml-4">
...
<?php /**PATH D:\work\Laravel\weatherapp\resources\views///layouts/app.blade.php ENDPATH**/ ?>